...
<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
	  ...
	  <!-- User Mangements -->
	  <?php $class=''; $menu_open=''; if($title == 'Users List'){ $menu_open = "menu-open"; $class= "active"; } ?>
	  <li class="treeview">
        <a >
          <i class="fa fa-th-list"></i> <span>Users Management</span><span class="pull-right-container">
	  ...
	  <!--li class="treeview">
        <a href="#">
          <i class="fa fa-dashboard"></i> <span>Transaction Mangement</span><span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
