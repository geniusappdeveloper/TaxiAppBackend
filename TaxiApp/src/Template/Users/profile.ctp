            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<tr>
					...
					<td>
						<?php echo $this->Form->input("email",array("type"=>"text",'readonly' => 'readonly',"class"=>"inp-form","label"=>false,"div"=>false));	 ?>
					</td>
				</tr>	
				<tr>
					<th valign="top">Image:  <span class="star">*</span></th>
					<td>
						<?php echo $this->Form->input("profile_pic",array("type"=>"file", "class"=>"inp-form","label"=>false,"div"=>false));	 ?>	
					</td>
				</tr>	
				<tr>
				<th>&nbsp;</th>
